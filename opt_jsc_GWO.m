function [F_comm, F_sensing, feasible, SSNR_opt] = opt_jsc_GWO(H_comm, sigmasq_comm, gamma, sensing_beamsteering, sensing_streams, sigmasq_sens, P_all, F_init)
    %% parameters
    SearchAgents_no = 30; % số lượng sói
    ...
    for l = 1:Max_iter
        ...
        if mod(l, 10) == 0
            fprintf('   GWO Iter: %d | Best Fit: %.2f\n', l, Alpha_score);
        end
    end
